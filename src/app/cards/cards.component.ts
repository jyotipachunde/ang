...
export class CardsComponent implements OnInit {
 ...
 spaceMissions:Array<{title: string, content: string}> = [
 ...
 worldCuisines: Array<{title: string, content: string}> = [
 ...
 mountainRanges: Array<{title: string, content: string}> = [
 ...
 famousAuthors: Array<{title: string, content: string}> = [
 ...
 prehistoricAnimals: Array<{title: string, content: string}> = [
 ...
 famousInventions: Array<{title: string, content: string}> = [
 ...
 movieGenres: Array<{title: string, content: string}> = [
 ...
 musicalGenres: Array<{title: string, content: string}> = [
 ...
 techInnovations: Array<{title: string, content: string}> = [
 ...
 famousRivers: Array<{title: string, content: string}> = [
 ...
 ancientStructures: Array<{title: string, content: string}> = [
 ...
 boardGames: Array<{title: string, content: string}> = [
 ...
 musicalInstrumentsWorld: Array<{title: string, content: string}> = [
 ...
 festivalsWorld: Array<{title: string, content: string}> = [
 ...
 wondersOfNature: Array<{title: string, content: string}> = [
